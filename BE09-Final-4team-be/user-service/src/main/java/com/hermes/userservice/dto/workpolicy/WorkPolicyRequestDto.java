...
public class WorkPolicyRequestDto {
    ...
    private String workCycle; // 선택 근무 전용
    ...
    private Integer workCycleStartDay; // 선택 근무 전용
    ...
    private Integer weeklyWorkingDays; // 교대 근무 전용
    
    private LocalTime startTime;
    
    private LocalTime startTimeEnd; // 시차 근무용
    ...
    private LocalTime coreTimeStart; // 선택 근무 전용
    
    private LocalTime coreTimeEnd; // 선택 근무 전용
    
    @NotNull(message = "휴게 시작 시간은 필수입니다.")
    private LocalTime breakStartTime;
    
    private LocalTime avgWorkTime; // 선택 근무 전용
